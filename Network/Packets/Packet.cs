...
namespace Network.Packets
{
    ...
    /// (this can be customised using the <see cref="PacketIgnorePropertyAttribute"/>). Allowed property types are listed
    ...
    /// deserialisation, whose properties will be read from a <see cref="MemoryStream"/>, deserialised and set accordingly.
    /// See <see cref="PacketConverter"/> for more on the serialisation and deserialisation process.
    /// </remarks>
