...
namespace Network.Extensions
{
    ...
    public static class ConcurrentBagExtensions
    {
        ...
        /// </summary>
        /// <typeparam name="T">The type for the elements held in the <see cref="ConcurrentBag{T}"/>.</typeparam>
        /// <param name="bag">The <see cref="ConcurrentBag{T}"/> instance that the extension method should affect.</param>
