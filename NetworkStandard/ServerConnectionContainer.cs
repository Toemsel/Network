...
namespace Network
{
    ...
    public class ServerConnectionContainer : ConnectionContainer
    {
        ...
        {
            return $"ServerConnectionContainer. IsOnline {IsTCPOnline}. EnableUDPConnection {AllowUDPConnections}. UDPConnectionLimit {UDPConnectionLimit}. Connected TCP connections {connections.Count}.";
        }
    }
}